...
const dummyMember = {
  id: 1,
  nama: "Bambang Surya Pratama",
  nik: "3201041234560001",
  alamat:
    "Jl. Merdeka No. 45, RT 03/RW 07, Kel. Sukamaju, Kec. Bogor Tengah, Kota Bogor",
  no_telepon: "081234567890",
  email: "bambang.surya@email.com",
  tanggal_bergabung: "2021-03-15",
  status: "Aktif",
  username: "bambang.surya",
  saldo_simpanan: 12500000,
  ...
  keluarga: [
    ...
    { id: 2, nama: "Ahmad Fauzan", hubungan: "Anak", no_telepon: "-" },
    { id: 3, nama: "Putri Amelia", hubungan: "Anak", no_telepon: "-" },
  ],
  simpanan: [
    { id: 1, jumlah: 500000, tanggal: "2024-12-01", jenis: "Iuran Bulanan" },
    { id: 2, jumlah: 500000, tanggal: "2024-11-01", jenis: "Iuran Bulanan" },
    {
      id: 3,
      jumlah: 1000000,
      tanggal: "2024-10-15",
    ...
    { id: 4, jumlah: 500000, tanggal: "2024-10-01", jenis: "Iuran Bulanan" },
    { id: 5, jumlah: 500000, tanggal: "2024-09-01", jenis: "Iuran Bulanan" },
  ],
  pinjaman: [
    {
      id: 1,
  ...
  cicilan: [
    {
      ...
      keterangan: "Cicilan ke-5",
    },
    {
      id: 2,
      jumlah: 700000,
      tanggal_bayar: "2024-11-01",
      keterangan: "Cicilan ke-4",
    },
    {
      id: 3,
      jumlah: 700000,
      tanggal_bayar: "2024-10-01",
      keterangan: "Cicilan ke-3",
    },
    {
      id: 4,
      jumlah: 700000,
      tanggal_bayar: "2024-09-01",
      keterangan: "Cicilan ke-2",
    },
    {
      id: 5,
      jumlah: 700000,
      tanggal_bayar: "2024-08-01",
...
const AnggotaPublicDetail = () => {
  // TODO: Replace dummyMember with API call using useParams().id
  ...
  const cicilanPercent = Math.round(
    (member.jumlah_cicilan / member.total_cicilan) * 100
  );
  ...
  return (
      <div className="min-h-screen bg-[#f7f5f0]">
        ...
        <header className="relative overflow-hidden bg-gradient-to-br from-[#0d3b2c] via-[#145a3f] to-[#1a6b50]">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 pt-14 pb-20 md:pt-16 md:pb-24">
...
>
                ...
                <p className="text-white/40 text-sm flex items-center justify-center md:justify-start gap-1.5">
                  ...
                  Bergabung sejak{" "}
                  {formatDate(member.tanggal_bergabung, "dd MMMM yyyy", {
                    locale: idLocale,
                  })}
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
            ...
            <div className="kp-scale-in kp-d1 bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-[#e7e5e0]">
              ...
              <p className="text-2xl md:text-3xl font-bold text-emerald-800">
                {formatCurrency(member.saldo_simpanan)}
              </p>
              <p className="text-xs mt-2 text-[#a8a29e]">
                {member.simpanan.length} transaksi tercatat
              </p>
            </div>
            ...
            <div className="kp-scale-in kp-d2 bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-[#e7e5e0]">
              ...
              <p className="text-xs mt-2 text-[#a8a29e]">
                {member.pinjaman.length} pinjaman tercatat
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {member.keluarga.map((family) => {
                ...
                return (
                  <div
                    key={family.id}
                    className="bg-white rounded-2xl p-5 shadow-sm border border-[#e7e5e0] hover:shadow-md transition-all duration-300"
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-[#fef3c7] text-[#92400e] flex items-center justify-center text-sm font-bold shrink-0">
                        {fInitials}
                      </div>
          ...
          <section className="kp-fade-up kp-d7">
            ...
            <div className="space-y-4">
              {member.pinjaman.map((item) => {
                ...
                const paidPercent =
                  item.jumlah > 0
                    ? ((item.jumlah - item.sisa) / item.jumlah) * 100
                    : 100;
                return (
                  <div
                    key={item.id}
